...
- [ ] Pressure-test speculative "agentic particle" / `Sophon` concept as a bounded distributed-observer architecture before any canonical promotion (`docs/archive/sophon_agentic_particles_v0.md`)
